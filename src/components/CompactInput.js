    ...
    return (
        <div className="group relative w-full h-12">
            <input
                ...
                className="peer w-full h-full pl-3 pr-3 pt-4 pb-1 lg:text-sm bg-zinc-50 dark:bg-zinc-800/50 border-b border-zinc-200 dark:border-zinc-700 rounded-lg  focus:bg-zinc-100 dark:focus:bg-zinc-800 focus:border-indigo-500 outline-none transition-all placeholder-transparent text-zinc-800 dark:text-zinc-200"
